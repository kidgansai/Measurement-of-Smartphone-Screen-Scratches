...
outInfo  drawCVRotRect(Mat & img, Point p1, Point p2, Point p3,int thinkness=1);  //angleΪ0-180
...
//////////////////////////////////////////////////////////////////////////
//图像增强
int rot_enhance(string annotation,Mat &newImg,string newAnnotatioin);
